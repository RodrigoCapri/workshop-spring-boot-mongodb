...
public class UserResource {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/{id}/posts") //Ou @GetMapping
	public ResponseEntity< List<Post> > finPosts(@PathVariable String id){ //Casar o atributo com a requisição
